                	    ...
                	    for (i = 0; i<responseText.payload.length; i++) {
                	    	$('#docPost').append(
                             ...
                             +"<div class=\"dc-docpostholder\">"
                                ...
                                +"<div class=\"dc-title\">"
                                +" <a href=\"javascript:void(0)\" class=\"dc-docstatus\">"+responseText.payload[i].specialization+"</a>"
                                +" <h3><a href=\"javascript:void(0);\">"+responseText.payload[i].firstName+"</a> <i class=\"fa fa-award dc-awardtooltip\"><em>Medical Registration Verified</em></i> <i class=\"fa fa-check-circle dc-awardtooltip\"><em>Medical Registration Verified</em></i></h3>"
                                +" <ul class=\"dc-docinfo\">"
                                +" <li>"
